		...
		<?php 
			...
			<?php
				...
				<tr class="odd gradeX">
					...
					<td><img src="uploads/<?php echo $result_slider['slider_image'] ?>" height="120px" width="200px"/></td>	
					<td>
						<?php
				...
				<td>
					<a href="slideredit.php?sliderid=<?php echo $result_slider['sliderId'] ?>">Edit</a> ||
					<a onclick="return confirm('Are you sure you want to remove this Slider from the Slider List Page?');" href="?del_slider=<?php echo $result_slider['sliderId'] ?>">Delete</a> 
				</td>
					</tr>	
					<?php
						}
